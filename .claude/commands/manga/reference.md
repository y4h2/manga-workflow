...
|---------|---------|------|
| setup | slow | 开场建立世界观 |
| inciting_incident | moderate | 触发事件 |
| rising_action | moderate | 冲突发展（可根据强度调整） |
| climax | fast | 故事高潮 |
| resolution | slow | 收束结局 |

### 节奏分配最佳实践

1. **确保节奏多样性**: 故事应包含至少两种节奏类型
2. **避免节奏单调**: 全是慢节奏会显得拖沓，全是快节奏会让观众疲劳
3. **镜头数偏差控制**: 实际镜头数与建议值偏差不宜超过 2
4. **高潮场景**: 至少有一个 fast 节奏场景作为故事高潮
5. **情感铺垫**: 至少有一个 slow 节奏场景用于情感铺垫
...
=== 节奏分析 ===
场景 1: 陆氏集团总部大厅 (setup)
  强度: 0.40, 节奏: slow, 建议: 2 镜头, 实际: 2 ✓

场景 2: 空中公路 (inciting_incident)
  强度: 0.80, 节奏: fast, 建议: 4 镜头, 实际: 4 ✓

场景 5: 废弃工厂 (climax)
  强度: 0.93, 节奏: fast, 建议: 5 镜头, 实际: 6 ↑

=== 节奏分布 ===
  慢: 2 (33%) | 中: 2 (33%) | 快: 2 (33%)
  ✓ 节奏分布均衡
```
